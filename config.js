...
module.exports = {
    ...
    ALIVETXT: process.env.ALIVETXT || 'Rika', //nothing😛
    ...
    BOT_INFO : process.env.BOT_INFO || "RONEN-BOTS,RIKA,https://i.imgur.com/DyLAuEh.jpg", // about the bot as img number for menu such plugins
    ...
    MENSION: {
        ...
        MENSION_TEXT : process.env.MENSION_TEXT || 'Rika,edit this and set your data, https://chat.whatsapp.com/CUJuk1xPEpR8av9h7DDGNO'
    },
